...
class ImageSyncNode : public rclcpp::Node {
 public:
  ...
  #if RCLCPP_VERSION_GTE(29,0,0)   // >= Kilted
    const auto& qos_profile = qos;
  #else
    const auto qos_profile = qos.get_rmw_qos_profile();
  #endif

    camera_01_color_sub_.subscribe(this, "/camera_01/color/image_raw", qos_profile);
    camera_01_depth_sub_.subscribe(this, "/camera_01/depth/image_raw", qos_profile);
    camera_02_color_sub_.subscribe(this, "/camera_02/color/image_raw", qos_profile);
    camera_02_depth_sub_.subscribe(this, "/camera_02/depth/image_raw", qos_profile);
    camera_03_color_sub_.subscribe(this, "/camera_03/color/image_raw", qos_profile);
    camera_03_depth_sub_.subscribe(this, "/camera_03/depth/image_raw", qos_profile);
    camera_04_color_sub_.subscribe(this, "/camera_04/color/image_raw", qos_profile);
    camera_04_depth_sub_.subscribe(this, "/camera_04/depth/image_raw", qos_profile);
